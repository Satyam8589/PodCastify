...
const LatestBlogs = ({ posts }) => {
  ...
  const fetchLatestPosts = async () => {
    try {
      ...
      if (posts && Array.isArray(posts)) {
        const latestFromProps =
          posts.length > 3 ? posts.slice(-3).reverse() : [...posts].reverse();
  ...
  const getPostUrl = (post) => {
    ...
    console.warn(
      "Post missing valid URL identifiers, redirecting to blogs page:",
      post
    );
    return "/blogs";
  };
      ...
      {loading ? (
        ...
        <div className="grid gap-6 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
          {[1, 2, 3].map((i) => (
            <div
              key={i}
              className="rounded-2xl overflow-hidden shadow-md border border-gray-200 bg-white animate-pulse"
            >
        ...
        <div className="grid gap-6 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
          {displayPosts.map((post) => {
            ...
            const postKey =
              post._id || post.id || post.slug || `post-${Math.random()}`;
            ...
            return (
              ...
              >
                <div className="relative">
                  <Image
                    src={
                      post.image?.url || post.image || "/placeholder-blog.jpg"
                    }
                ...
                <div className="p-4">
                  ...
                  <h3
                    className="text-lg font-semibold text-black mb-2 leading-tight line-clamp-2"
